...
class Ui_MapLap(object):
    def setupUi(self, MapLap):
        ...
        self.pencil.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("maplap/templates/pensil.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.eraser.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("maplap/templates/eraser.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
